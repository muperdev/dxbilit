...
const Blogs = () => {
  ...
  return (
    <div className='flex flex-col justify-center items-center'>
      <div className='flex flex-col-reverse lg:flex-row justify-between items-center px-4 w-full lg:w-10/12 my-10'>
        <div className='flex flex-col justify-center items-center lg:justify-end mt-3 lg:mt-0 lg:items-end w-full lg:w-3/4 mr-8 text-right'>
          ...
          <p className='text-xl font-semibold my-2 leading-10 text-right'>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و با استفاده از طراحان گرافیک</p>
